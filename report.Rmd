...
`r paste0("\\textcolor{red}{\r\n\r\n\r\nAvertissements:", paste(paste0("\r\n\r\n* ", computation_results$warning_items), collapse=""), "}")`

```{r, echo=FALSE, warning=FALSE}
if (computation_results$warning_level < WARNING_LEVEL_WARN) {  # TODO change to STOP
...
`r if(computation_results$warning_level < WARNING_LEVEL_WARN){paste0("**Conclusion:** ", computation_results$com_concl)} else {"Impossible d'interpréter le spectre."}`
